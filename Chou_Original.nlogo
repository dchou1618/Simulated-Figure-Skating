...
The skaters would follow their nearest neighbor, within their perception radius. Thus, when the program runs, the skaters would fall if they collide with one another. They could avoid collision if they have a high enough turning ability with a decent speed. It’s assumed that when skaters leave the screen, it’s attributed to random error or from skaters exiting the rink.
...
Considering skaters who idle in the center circle and end zones. 
